...
% final user command
  \iftrkv@expand%
  \trkv@pairparser@defcommand{#3}{#4}{#5}%
    {\ex@f\trt@macro@fullexpand\ex@f{\the\toks@}->T{\toks@}}%
  \else%
...
% {<cs>/command name/} {<num>/number of args/} {/code/} {/preproc/} 
%% preproc is an action on token list \toks@
\def \trkv@pairparser@defcommand#1#2#3#4{
  \edef \trt@exphandler{%
    \unexpanded{\newcommand{#1}[#2]}{%
